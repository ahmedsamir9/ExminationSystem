...
namespace Examination_System.Reports.GetInstCourses
{
    public partial class GetInstCourses : MaterialForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tbDeptID.Hint = "Instructor ID";
            ...
            this.Name = "GetInstCourses";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Courses for Instructor Report";
        ...
        private void BtnShowReport_Click(object sender, EventArgs e)
        {
            ...
            {
                new Examination_System.Reports.GetInstCourses.GetCourseTopicsViewer(int.Parse(tbDeptID.Text)).Show();
            }
            else
            {
