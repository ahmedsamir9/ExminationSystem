...
{
    public partial class StudentDetailsinDept : MaterialForm
    {
        private MaterialTextBox tbDeptID;
        private MaterialButton btnBack;
        private MaterialButton btnShowReport;

        public StudentDetailsinDept()
        {
            InitializeComponent();
            InitForm();
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.tbDeptID.Hint = "Department ID";
            ...
            this.Name = "StudentDetailsinDept";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Student in Department Report";
        ...
        private void BtnShowReport_Click(object sender, EventArgs e)
        {
            ...
            {
                new StudentDetailsinDeptViewer(int.Parse(tbDeptID.Text)).Show();
            }
            else
            {
