...
{
    public partial class GetExamQuestions : MaterialForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "GetExamQuestions";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Questions in Exam Report";
        ...
        private void BtnShowReport_Click(object sender, EventArgs e)
        {
            ...
            {
                new GetExamQuestionsViewer(int.Parse(tbDeptID.Text)).Show();
            }
            else
            {
                MessageBox.Show("Please Enter Exam ID");
            }
        }
